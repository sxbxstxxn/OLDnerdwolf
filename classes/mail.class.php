...
class NerdwolfMail {
	...
	function getMessage($type, $assignments) {
		...
		$smarty = new Smarty;
		$smarty->template_dir = '/www/htdocs/w0131f27/nerdwolf.eu/templates/';
		$smarty->compile_dir = '/www/htdocs/w0131f27/nerdwolf.eu/templates_c/';
		$smarty->config_dir = '/www/htdocs/w0131f27/nerdwolf.eu/configs/';
		$smarty->cache_dir = '/www/htdocs/w0131f27/nerdwolf.eu/cache/';		
