<?php
require('config.php');
require('/www/htdocs/w0131f27/nerdwolf.eu/lib/smarty-3.1.30/Smarty.class.php');

class NerdwolfPage extends Smarty {
	function __construct()	
	{
		parent::__construct();

		$this->template_dir = '/www/htdocs/w0131f27/nerdwolf.eu/templates/';
		$this->compile_dir = '/www/htdocs/w0131f27/nerdwolf.eu/templates_c/';
		$this->config_dir = '/www/htdocs/w0131f27/nerdwolf.eu/configs/';
		$this->cache_dir = '/www/htdocs/w0131f27/nerdwolf.eu/cache/';	
