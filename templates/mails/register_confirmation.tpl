<table cellpadding="5" cellspacing="0" width="100%" bgcolor="#000000" style="color:#00FD00;font-family:'VT323',monospace">
	<thead>
		<tr>
			<th width="32px"><img src="http://nerdwolf.eu/images/icons/icon_nerdwolf_32x32.jpg"></th>
	...
	<tfoot>
		<tr>
			<td>&nbsp;</td>
			<td style="text-align:center;">&copy; <a href="http://nerdwolf.eu" target="_blank" style="color:#00FD00;font-family:'VT323',monospace">Nerdwolf</td>
			<td>&nbsp;</td>
		</tr>
	</tfoot>
</table>